   ...
   test('CC - Copy Back Reference Backwards (Copy 0+2 bytes backwards from offset 3)', () => {
    ...
    test('9A 83 - Copy Back Reference ( 6 * Math.floor(A / 4) + (A % 4) + 10 bytes from offset 0x83+1 back)', () => {
        testCommand(
            ...
            "65 41 11 11 65 41 11 11 65 41 11 11 65 41 11 11 65 41 11 11 65 41 11" // expected result -- count = 34
        );
    });
    test('9F 80 - Copy Back Reference ( 6 * Math.floor(9 / 4) + (9 % 4) + 10 bytes from offset 3+1 back)', () => {
        testCommand(
