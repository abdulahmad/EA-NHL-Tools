...
2. Run `npm install`
3. Run `node getNHLTeams.js` to get team data
4. Run `node getNHLPlayerData.js` to get player data from NHL APIs
5. Run `node getNHL23Ratings` to get ratings for players
