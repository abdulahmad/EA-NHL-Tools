...
const assets = [
    ...
    { name: 'Unknown93-5.map.jzip2', folder: 'NHL93/Graphics', start: 0x322CE, end: 0x32860 },
    { name: 'EABkgd93.map.jzip', folder: 'NHL93/Graphics', start: 0x32860, end: 0x3338C },
    { name: 'Unknown93-6.map.jzip2', folder: 'NHL93/Graphics', start: 0x3338C, end: 0x33864 },
    { name: 'Unknown93-7.map.jzip', folder: 'NHL93/Graphics', start: 0x33864, end: 0x3890A },
    { name: 'Unknown93-7.map.jzip', folder: 'NHL93/Graphics', start: 0x3890A, end: 0x39466 },
    ...
    { name: 'SmallFont.map.jim', folder: 'NHL93/Graphics', start: 0x795B8, end: 0x7A286 },
    { name: 'Unknown93-6.map.jzip2', folder: 'NHL93/Graphics', start: 0x7A286, end: 0x7A375 },
    { name: 'Unknown93-7.map.jzip2', folder: 'NHL93/Graphics', start: 0x7A375, end: 0x7C552 },
    { name: 'Unknown93-8.map.jzip2', folder: 'NHL93/Graphics', start: 0x7C552, end: 0x7C7AD },
    { name: 'Unknown93-9.bin', folder: 'NHL93/Graphics', start: 0x7C7AD, end: 0x7C946 },
