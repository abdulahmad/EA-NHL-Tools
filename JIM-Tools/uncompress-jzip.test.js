...
describe('ronbarr.map.jzip decompression', () => {
    ...
    test('83 B8 - Copy Back Reference Pattern (Sequence is 3+3 bytes long, copy pattern from B8 bytes back)', () => {
        testCommand(
            ...
            /*
00 71   83 B8               5E                        00 71   80 8F       00 11   CC       03 88 89 22 18
71      77 77 77 18 77 77   77 18 77 77 77 18 77 77   71      11 77 77    11      11 71    88 89 22 18

5E E -> 1110 -> 3, 2 -> 8 length
51 1 -> 0001 -> 0, 1 -> 3 length 

00 18   51         00 88   51        00 92
18      77 77 18   88      77 18 88  92
            */
   ...
   test('CC - Copy Back Reference Backwards (Copy 0+2 bytes backwards from offset 3)', () => {
    ...
    // CC       E0 37       04 98 88 89 AC CA
    // 66 FF    88 88 99    98 88 89 AC CA
