...
const assets = [
    ...
    { name: 'Walesh.pal', folder: 'NHL93/Graphics/Pals', start: 0x388, end: 0x3A8 },
    { name: 'Walesv.pal', folder: 'NHL93/Graphics/Pals', start: 0x3A8, end: 0x3C8 },
    { name: 'Campbellh.pal', folder: 'NHL93/Graphics/Pals', start: 0x624, end: 0x644 },
    ...
    { name: 'Bruinsv.pal', folder: 'NHL93/Graphics/Pals', start: 0x8E4, end: 0x944 },
